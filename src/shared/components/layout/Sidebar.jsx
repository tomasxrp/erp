...
import { Users, Package, FileText, ShoppingCart, BarChart3, Box, Briefcase, X, Settings, Wrench, Building2, ClipboardList } from 'lucide-react';
...
export default function Sidebar({ isOpen, onClose }) {
  ...
  const menuItems = [
    ...
    { path: '/cotizaciones',        label: 'Cotizaciones',      icon: ClipboardList, roles: ['admin', 'vendedor'] },
    ...
    { path: '/registros',           label: 'Historial',         icon: FileText,      roles: ['admin', 'vendedor'] },
    { path: '/trabajadores',        label: 'Trabajadores',      icon: Users,         roles: [] },
